...
/**
 * Class to implement UPI Payment
 * <p>
 * Use {@link Builder} to create a new instance of IndiUpi.
 */
public final class MatUpi {
    private Activity mActivity;
    private PaymentPayload mPayment;

    private MatUpi(@NonNull final Activity mActivity, @NonNull PaymentPayload mPayment) {
    ...
    public static final class Builder {
        ...
        public MatUpi build() {
            ...
            return new MatUpi(activity, payment);
        }
    }
}
