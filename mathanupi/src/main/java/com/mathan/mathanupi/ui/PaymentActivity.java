...
public final class PaymentActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (paymentIntent.resolveActivity(getPackageManager()) != null) {
            ...
            List<ResolveInfo> newlist=new ArrayList<>();

            for (ResolveInfo resolveInfo : intentList){


                if (resolveInfo.activityInfo.packageName.equals("com.phonepe.app")){
                    Intent intent1 = new Intent();
                    intent1.setPackage("com.phonepe.app");
                    intent1.setData(uri);
                    ResolveInfo resolveInfo1=getPackageManager().resolveActivity(intent1,0);
                    newlist.add(resolveInfo1);

                }
                if (resolveInfo.activityInfo.packageName.equals("com.google.android.apps.nbu.paisa.user")){
                    Intent intent1 = new Intent();
                ...
                if (resolveInfo.activityInfo.packageName.equals("in.org.npci.upiapp")){
                    Intent intent1 = new Intent();
                    intent1.setPackage("in.org.npci.upiapp");
                    intent1.setData(uri);
                    ResolveInfo resolveInfo1=getPackageManager().resolveActivity(intent1,0);
                    newlist.add(resolveInfo1);
                }
            ...
            if (newlist.isEmpty()){
               ...
               onBackPressed();
                ...
                showApps(newlist, paymentIntent);
            }
